...
H_min_pred = uotod.match.Min(loc_match_cost=L, bg_cost=0.8, closest='target')
H_unbalanced_pred = uotod.match.UnbalancedSinkhorn(loc_match_cost=L, bg_cost=0.8, reg=0.01, reg_target=100., reg_pred=0.1)
