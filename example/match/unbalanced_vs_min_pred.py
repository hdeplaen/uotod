...
H_min_pred = uotod.match.Min(loc_match_cost=L, background_cost=0.8, source='prediction')
H_unbalanced_pred_small_reg = uotod.match.UnbalancedSinkhorn(loc_match_cost=L, background_cost=0.8, reg=0.01, reg_target=0.1, reg_pred=1.e+3)
H_unbalanced_pred_big_reg = uotod.match.UnbalancedSinkhorn(loc_match_cost=L, background_cost=0.8, reg=0.1, reg_target=0.1, reg_pred=1.e+3)
