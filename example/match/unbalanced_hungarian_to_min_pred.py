...
H_min_pred = uotod.match.Min(loc_match_cost=L, bg_cost=0.8, closest='prediction')
H_unbalanced_pred = uotod.match.UnbalancedSinkhorn(loc_match_cost=L, bg_cost=0.8, reg=0.01, reg_target=0.1, reg_pred=20.)
H_hungarian = uotod.match.Hungarian(loc_match_cost=L, bg_cost=0.8)
