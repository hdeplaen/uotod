...
H_balanced_small_reg = uotod.match.BalancedSinkhorn(loc_match_cost=L, bg_cost=0.8, reg=0.01)
H_balanced_big_reg = uotod.match.BalancedSinkhorn(loc_match_cost=L, bg_cost=0.8, reg=0.1)
